...
var Resolver = class {
  constructor(props) {
    __publicField(this, "moduleBasedResolver", true);
    __publicField(this, "_deprecatedPodModulePrefix", false);
    __publicField(this, "_normalizeCache", /* @__PURE__ */ Object.create(null));
    /**
     ...
     @returns {Ember.Array}
     */
    __publicField(this, "moduleNameLookupPatterns", [this.podBasedModuleName, this.podBasedComponentsInSubdir, this.mainModuleName, this.defaultModuleName, this.nestedColocationComponentModuleName]);
  ...
  static withModules(explicitModules) {
    ...
    }, __publicField(_a, "explicitModules", explicitModules), _a;
  }
...
__publicField(Resolver, "moduleBasedResolver", true);
