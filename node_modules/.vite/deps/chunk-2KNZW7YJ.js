import {
  ...
  isEqual,
  isPresent
} from "./chunk-LJRTKYDN.js";
import {
  registerDestructor,
  unregisterDestructor
} from "./chunk-E4BDM3EX.js";
import {
  Application,
  ApplicationInstance,
  ComponentLookup,
  ...
  runLoadHooks,
  setOwner
} from "./chunk-W54MLWQ2.js";
import {
  setComponentManager
} from "./chunk-LKTNHS2B.js";
import {
  Component,
  EventDispatcher,
  Helper,
...
// node_modules/.embroider/rewritten-packages/@glimmer/component.b4095656/node_modules/@glimmer/component/-private/destroyables.js
var destroyables_exports = {};
__export(destroyables_exports, {
  isDestroyed: () => isDestroyed2,
  isDestroying: () => isDestroying2
});

// node_modules/ember-source/dist/packages/@ember/canary-features/index.js
var DEFAULT_FEATURES = {
  // FLAG_NAME: true/false
};
var FEATURES = Object.assign(DEFAULT_FEATURES, ENV.FEATURES);
...
// node_modules/ember-source/dist/packages/shared-chunks/template_registry-DigcUg9m.js
var TEMPLATES = {};
...
// node_modules/ember-source/dist/packages/@ember/debug/data-adapter.js
function iterate(arr, fn2) {
...
var DataAdapter = class extends EmberObject {
  // TODO: Revisit this
  constructor(owner) {
    super(owner);
    __publicField(this, "releaseMethods", A());
    __publicField(this, "recordsWatchers", /* @__PURE__ */ new Map());
    __publicField(this, "typeWatchers", /* @__PURE__ */ new Map());
    __publicField(this, "flushWatchers", null);
    /**
    ...
    **/
    /**
      ...
      @since 1.3.0
    */
    __publicField(this, "attributeLimit", 3);
    /**
     ...
     */
    __publicField(this, "acceptsModelName", true);
  ...
  */
  watchModelTypes(typesAdded, typesUpdated) {
    ...
    let release = () => {
      releaseMethods.forEach((fn2) => fn2());
  ...
  */
  willDestroy() {
    ...
    this.releaseMethods.forEach((fn2) => fn2());
...
// node_modules/ember-source/dist/packages/@ember/array/proxy.js
...
var ArrayProxy = class extends EmberObject {
  constructor() {
    ...
    */
    /** @internal */
    __publicField(this, "_objectsDirtyIndex", 0);
    /** @internal */
    __publicField(this, "_objects", null);
    /** @internal */
    __publicField(this, "_lengthDirty", true);
    /** @internal */
    __publicField(this, "_length", 0);
    /** @internal */
    __publicField(this, "_arrangedContent", null);
    /** @internal */
    __publicField(this, "_arrangedContentIsUpdating", false);
    /** @internal */
    __publicField(this, "_arrangedContentTag", null);
    /** @internal */
    __publicField(this, "_arrangedContentRevision", null);
    /** @internal */
    __publicField(this, "_lengthTag", null);
    /** @internal */
    __publicField(this, "_arrTag", null);
  }
  init(props) {
    super.init(props);
...
// node_modules/ember-source/dist/packages/@ember/object/proxy.js
var ObjectProxy = class extends FrameworkObject {
};
ObjectProxy.PrototypeMixin.reopen(ProxyMixin);

// node_modules/ember-source/dist/packages/@ember/object/promise-proxy-mixin.js
...
// node_modules/ember-source/dist/packages/@ember/routing/lib/controller_for.js
function controllerFor(container, controllerName, lookupOptions) {
  return container.lookup(`controller:${controllerName}`, lookupOptions);
}

// node_modules/ember-source/dist/packages/@ember/test/index.js
...
// node_modules/ember-source/dist/packages/@ember/template-compilation/index.js
...
// node_modules/ember-source/dist/packages/ember/barrel.js
var Ember;
(function(_Ember) {
  ...
  _Ember.Debug = {
    ...
    registerWarnHandler: registerHandler2,
  ...
  function inject$1() {
    assert(`Injected properties must be created through helpers, see '${globalThis.Object.keys(inject$1).map((k) => `'inject.${k}'`).join(" or ")}'`);
  }
  ...
  _Ember.__loader = {
    ...
    get registry() {
      var _a;
      let g = globalThis;
      return ((_a = g.requirejs) == null ? void 0 : _a.entries) ?? g.require.entries;
    }
  };
})(Ember || (Ember = {}));
...
runLoadHooks("Ember");
var doNotUseThis = Ember;

// node_modules/ember-source/dist/packages/ember/index.js
var index = new Proxy(doNotUseThis, {
...
// node_modules/.embroider/rewritten-packages/@glimmer/component.b4095656/node_modules/@glimmer/component/-private/destroyables.js
var isDestroying2 = index._isDestroying;
var isDestroyed2 = index._isDestroyed;

// node_modules/.embroider/rewritten-packages/@glimmer/component.b4095656/node_modules/@glimmer/component/-private/component.js
...
var BaseComponent = class {
  ...
  get isDestroying() {
    return isDestroying2(this);
  }
  get isDestroyed() {
    return isDestroyed2(this);
  }
  /**
...
// node_modules/.embroider/rewritten-packages/@glimmer/component.b4095656/node_modules/@glimmer/component/-private/base-component-manager.js
...
function BaseComponentManager(setOwner2, getOwner3, capabilities) {
  return class {
    static create(attrs) {
      let owner = getOwner3(attrs);
      return new this(owner);
    }
    constructor(owner) {
      _defineProperty2(this, "capabilities", capabilities);
      setOwner2(this, owner);
    }
    createComponent(ComponentClass, args) {
      if (true) {
        ARGS_SET.set(args.named, true);
      }
      return new ComponentClass(getOwner3(this), args.named);
    }
...
// node_modules/.embroider/rewritten-packages/@glimmer/component.b4095656/node_modules/@glimmer/component/-private/ember-component-manager.js
var {
  setDestroyed,
  setDestroying
} = destroyables_exports;
var CAPABILITIES = true ? componentCapabilities("3.13", {
  destructor: true,
  asyncLifecycleCallbacks: false,
  updateHook: false
}) : componentCapabilities("3.4", {
  destructor: true,
  asyncLifecycleCallbacks: false
});
var destroy2 = true ? index.destroy : (component) => {
  if (component.isDestroying) {
    return;
  }
  let meta2 = index.meta(component);
  meta2.setSourceDestroying();
  setDestroying(component);
  schedule("actions", component, component.willDestroy);
  schedule("destroy", void 0, scheduledDestroyComponent, component, meta2);
};
var registerDestructor2 = true ? index._registerDestructor : true ? index.__loader.require("@glimmer/runtime").registerDestructor : void 0;
var EmberGlimmerComponentManager = class extends BaseComponentManager(setOwner, getOwner2, CAPABILITIES) {
  createComponent(ComponentClass, args) {
    const component = super.createComponent(ComponentClass, args);
    if (true) {
      registerDestructor2(component, () => {
...
var ember_component_manager_default = EmberGlimmerComponentManager;

export {
  BaseComponent,
  ember_component_manager_default
};
//# sourceMappingURL=chunk-2KNZW7YJ.js.map
