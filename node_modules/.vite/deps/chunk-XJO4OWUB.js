...
// node_modules/ember-source/dist/packages/@ember/owner/index.js
var owner_exports = {};
...
// node_modules/ember-source/dist/packages/@ember/routing/lib/cache.js
...
// node_modules/ember-source/dist/packages/@ember/routing/lib/dsl.js
var uuid = 0;
...
var DSLImpl = class _DSLImpl {
  constructor(name = null, options) {
    ...
    __publicField(this, "enableLoadingSubstates");
    __publicField(this, "explicitIndex", false);
...
// node_modules/ember-source/dist/packages/@ember/routing/lib/router_state.js
var RouterState = class {
  constructor(emberRouter, router, routerJsState) {
    __publicField(this, "router");
    __publicField(this, "emberRouter");
    __publicField(this, "routerJsState");
...
// node_modules/ember-source/dist/packages/shared-chunks/router-BViwI_oJ.js
...
function toReadOnlyRouteInfo(routeInfos, queryParams = {}, options = {
  ...
  return routeInfos.map((info2, i) => {
    ...
    if (ROUTE_INFOS.has(key) && options.includeAttributes) {
      ...
      let routeInfoWithAttribute = createRouteInfoWithAttributes(routeInfo2, context);
...
// node_modules/ember-source/dist/packages/@ember/routing/router.js
...
var _EmberRouter = class _EmberRouter extends EmberObject.extend(Evented) {
  ...
  constructor(owner) {
    ...
    */
    // Set with reopen to allow overriding via extend
    __publicField(this, "_routerMicrolib");
    __publicField(this, "_didSetupRouter", false);
    __publicField(this, "_initialTransitionStarted", false);
    __publicField(this, "currentURL", null);
    __publicField(this, "currentRouteName", null);
    __publicField(this, "currentPath", null);
    __publicField(this, "currentRoute", null);
    __publicField(this, "_qpCache", /* @__PURE__ */ Object.create(null));
    // Set of QueryParam['urlKey']
    __publicField(this, "_qpUpdates", /* @__PURE__ */ new Set());
    __publicField(this, "_queuedQPChanges", {});
    __publicField(this, "_bucketCache");
    __publicField(this, "_toplevelView", null);
    __publicField(this, "_handledErrors", /* @__PURE__ */ new Set());
    __publicField(this, "_engineInstances", /* @__PURE__ */ Object.create(null));
    __publicField(this, "_engineInfoByRoute", /* @__PURE__ */ Object.create(null));
    __publicField(this, "_routerService");
    __publicField(this, "_slowTransitionTimer", null);
    __publicField(this, "namespace");
    __publicField(this, "currentState", null);
    __publicField(this, "targetState", null);
  ...
  */
  ...
  _setOutlets() {
    ...
    if (!this._toplevelView) {
      ...
      !(environment !== void 0) && assert("[BUG] unexpectedly missing `-environment:main`", environment !== void 0);
  ...
  */
  ...
  _setupLocation() {
    ...
    if ("string" === typeof location) {
      ...
      !resolvedLocation && assert(`Could not resolve a location class at 'location:${location}'`, resolvedLocation);
...
__publicField(_EmberRouter, "dslCallbacks");
var EmberRouter = _EmberRouter;
...
function updatePaths(router) {
  ...
  !(typeof location !== "string") && assert("expected location to not be a string", typeof location !== "string");
...
//# sourceMappingURL=chunk-XJO4OWUB.js.map
