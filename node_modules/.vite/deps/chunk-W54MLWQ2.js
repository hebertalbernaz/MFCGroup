...
// node_modules/ember-source/dist/packages/@ember/application/lib/lazy_load.js
var loadHooks = ENV.EMBER_LOAD_HOOKS || {};
var loaded = {};
var _loaded = loaded;
function onLoad(name, callback) {
  let object = loaded[name];
  let hooks = loadHooks[name] ?? (loadHooks[name] = []);
  hooks.push(callback);
  if (object) {
    callback(object);
  }
...
function runLoadHooks(name, object) {
  ...
  (_a = loadHooks[name]) == null ? void 0 : _a.forEach((callback) => callback(object));
}

// node_modules/ember-source/dist/packages/@ember/routing/lib/location-utils.js
...
// node_modules/ember-source/dist/packages/@ember/routing/hash-location.js
var HashLocation = class extends EmberObject {
  constructor() {
    super(...arguments);
    __publicField(this, "_hashchangeHandler");
    __publicField(this, "_location");
    __publicField(this, "lastSetURL", null);
  }
  init() {
...
// node_modules/ember-source/dist/packages/@ember/routing/history-location.js
...
var HistoryLocation = class extends EmberObject {
  constructor() {
    ...
    __publicField(this, "_previousURL");
    __publicField(this, "_popstateHandler");
    /**
...
// node_modules/ember-source/dist/packages/@ember/routing/none-location.js
...
// node_modules/ember-source/dist/packages/@ember/application/instance.js
  ...
  constructor(options = {}) {
    ...
    */
    ...
    /**
      ...
      @private
    */
    __publicField(this, "_renderMode");
    /**
    ...
    */
    ...
    /**
      ...
      @public
    */
    __publicField(this, "shouldRender");
    /**
...
// node_modules/ember-source/dist/packages/shared-chunks/invoke-BjRgvK2V.js
function canInvoke(obj, methodName) {
  return obj != null && typeof obj[methodName] === "function";
}

// node_modules/ember-source/dist/packages/@ember/application/namespace.js
...
__publicField(Namespace, "NAMESPACES", NAMESPACES);
__publicField(Namespace, "NAMESPACES_BY_ID", NAMESPACES_BY_ID);
__publicField(Namespace, "processAll", processAllNamespaces);
__publicField(Namespace, "byName", findNamespace);
Namespace.prototype.isNamespace = true;

// node_modules/ember-source/dist/packages/dag-map/index.js
var DAG = function() {
  function DAG2() {
...
// node_modules/ember-source/dist/packages/@ember/debug/container-debug-adapter.js
...
// node_modules/ember-source/dist/packages/@ember/-internals/views/lib/component_lookup.js
...
// node_modules/ember-source/dist/packages/@glimmer/node/index.js
...
// node_modules/ember-source/dist/packages/shared-chunks/setup-registry-DktVPnKH.js
...
// node_modules/ember-source/dist/packages/@ember/engine/index.js
function props(obj) {
  let properties = [];
  for (let key in obj) {
    properties.push(key);
...
var Engine = class extends Namespace.extend(RegistryProxyMixin) {
  constructor() {
    ...
    */
    __publicField(this, "_initializersRan", false);
  }
  /**
...
__publicField(Engine, "initializers", /* @__PURE__ */ Object.create(null));
__publicField(Engine, "instanceInitializers", /* @__PURE__ */ Object.create(null));
/**
  ...
  @public
*/
__publicField(Engine, "initializer", buildInitializerMethod("initializers", "initializer"));
/**
  ...
  @public
*/
__publicField(Engine, "instanceInitializer", buildInitializerMethod("instanceInitializers", "instance initializer"));
...
var _Application = class _Application extends Engine {
  constructor() {
    super(...arguments);
    __publicField(this, "Router");
    __publicField(this, "__deprecatedInstance__");
    __publicField(this, "__container__");
    __publicField(this, "_bootPromise", null);
    __publicField(this, "_bootResolver", null);
  }
  /**
    This creates a registry with the default Ember naming conventions.
     It also configures the registry:
  ...
  */
  init(properties) {
    var _a, _b;
    super.init(properties);
    this.rootElement ?? (this.rootElement = "body");
    this._document ?? (this._document = null);
    this.eventDispatcher ?? (this.eventDispatcher = null);
    this.customEvents ?? (this.customEvents = null);
    this.autoboot ?? (this.autoboot = true);
    this._document ?? (this._document = hasDOM ? window.document : null);
    this._globalsMode ?? (this._globalsMode = true);
    if (true) {
      if (ENV.LOG_VERSION) {
        ENV.LOG_VERSION = false;
        (_b = (_a = LIBRARIES).logVersions) == null ? void 0 : _b.call(_a);
      }
    }
...
__publicField(_Application, "initializer", buildInitializerMethod("initializers", "initializer"));
__publicField(_Application, "instanceInitializer", buildInitializerMethod("instanceInitializers", "instance initializer"));
...
//# sourceMappingURL=chunk-W54MLWQ2.js.map
