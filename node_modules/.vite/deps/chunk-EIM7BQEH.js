...
} from "./chunk-WVWXNYQ7.js";
import {
  EvaluationContextImpl,
  templateFactory
} from "./chunk-5RFJZXJH.js";
import {
  Service,
  dasherize,
  service
} from "./chunk-PNPRY6HP.js";
import {
  EmberRouter
} from "./chunk-XJO4OWUB.js";
import {
  EngineInstance,
  Evented,
  decorateFieldV2,
...
// node_modules/ember-source/dist/packages/@ember/modifier/on.js
var on2 = on;

// node_modules/ember-source/dist/packages/@ember/instrumentation/index.js
var subscribers = [];
var cache = {};
...
// node_modules/ember-source/dist/packages/@ember/-internals/views/lib/views/states.js
...
// node_modules/ember-source/dist/packages/@ember/-internals/views/lib/views/core_view.js
var _renderer;
var _CoreView = class _CoreView extends FrameworkObject.extend(Evented, ActionHandler) {
  ...
  */
  init(properties) {
    ...
    this.has = this._has;
    this.parentView ?? (this.parentView = null);
...
// node_modules/ember-source/dist/packages/@ember/-internals/views/lib/mixins/action_support.js
...
// node_modules/ember-source/dist/packages/@ember/-internals/views/lib/system/utils.js
...
// node_modules/ember-source/dist/packages/@ember/-internals/views/lib/system/event_dispatcher.js
...
var EventDispatcher = class extends EmberObject {
  constructor() {
    ...
    */
    ...
    /**
      ...
      @default 'body'
    */
    __publicField(this, "rootElement", "body");
    __publicField(this, "_eventHandlers", /* @__PURE__ */ Object.create(null));
    __publicField(this, "_didSetup", false);
    __publicField(this, "finalEventNameMapping", null);
    __publicField(this, "_sanitizedRootElement", null);
    __publicField(this, "lazyEvents", /* @__PURE__ */ new Map());
    __publicField(this, "_reverseEventNameMapping", null);
  }
  /**
  ...
  */
  setup(addedEvents, _rootElement) {
    ...
    !rootElement.classList.contains(ROOT_ELEMENT_CLASS) && assert(`Unable to add '${ROOT_ELEMENT_CLASS}' class to root element (${get(this, "rootElement") || rootElement.tagName}). Make sure you set rootElement to the body or an element in the body.`, rootElement.classList.contains(ROOT_ELEMENT_CLASS));
  ...
  */
  setupHandlerForEmberEvent(eventName) {
    ...
    let event = (_a6 = this._reverseEventNameMapping) == null ? void 0 : _a6[eventName];
    if (event) {
...
// node_modules/ember-source/dist/packages/@ember/object/lib/computed/computed_macros.js
...
// node_modules/ember-source/dist/packages/@ember/routing/router-service.js
...
// node_modules/ember-source/dist/packages/@ember/routing/lib/routing-service.js
var _a2, _b2;
var RoutingService = class extends (_b2 = Service, _a2 = ROUTER, _b2) {
  constructor() {
    super(...arguments);
...
// node_modules/ember-source/dist/packages/@ember/-internals/views/lib/compat/attrs.js
var MUTABLE_CELL = Symbol("MUTABLE_CELL");

// node_modules/ember-source/dist/packages/shared-chunks/index-DaCZcoCY.js
...
var ForkedValue = class {
  constructor(reference) {
    ...
    __publicField(this, "lastUpstreamValue", UNINITIALIZED);
...
var _AbstractInput = class _AbstractInput extends InternalComponent {
  constructor() {
    super(...arguments);
    __publicField(this, "_value", valueFrom(this.args.named["value"]));
  }
  validateArguments() {
...
var __Input = class __Input extends AbstractInput {
  constructor() {
    super(...arguments);
    __publicField(this, "_checked", valueFrom(this.args.named["checked"]));
  }
  static toString() {
    return "Input";
  }
...
var ComponentStateBucket = class {
  constructor(component, args, argsTag, finalizer, hasWrappedElement, isInteractive) {
    __publicField(this, "classRef", null);
    __publicField(this, "rootRef");
    __publicField(this, "argsRevision");
...
var CurlyComponentManager = class {
  ...
  getDebugName(definition) {
    var _a6;
    return definition.fullName || definition.normalizedName || ((_a6 = definition.class) == null ? void 0 : _a6.name) || definition.name;
  }
  getSelf({
    rootRef
  }) {
...
var _Component = class _Component extends CoreView.extend(TargetActionSupport, ActionSupport, {
  ...
  constructor() {
    ...
    __publicField(this, "__dispatcher");
  }
  ...
  */
  ...
  on(name, target, method) {
    var _a6;
    (_a6 = this._dispatcher) == null ? void 0 : _a6.setupHandlerForEmberEvent(name);
...
var _a4, _b4;
var Helper = class extends (_b4 = FrameworkObject, _a4 = IS_CLASSIC_HELPER, _b4) {
...
__publicField(Helper, "isHelperFactory", true);
__publicField(Helper, _a4, true);
...
/** @deprecated */
__publicField(Helper, "helper", helper$1);
function isClassicHelper(obj) {
  return obj[IS_CLASSIC_HELPER] === true;
}
var ClassicHelperManager = class {
  constructor(owner) {
    __publicField(this, "capabilities", helperCapabilities("3.23", {
      hasValue: true,
      hasDestroyable: true
    }));
    __publicField(this, "ownerInjection");
    let ownerInjection = {};
...
var Wrapper = class {
  constructor(compute) {
    __publicField(this, "isHelperFactory", true);
...
var OutletComponentManager = class {
  create(_owner, definition, _args, env, dynamicScope) {
    ...
    if (env.debugRenderTree !== void 0) {
      ...
      let parentOwner = (_a6 = parentState == null ? void 0 : parentState.render) == null ? void 0 : _a6.owner;
      let currentState = valueForRef(currentStateRef);
      let currentOwner = (_b6 = currentState == null ? void 0 : currentState.render) == null ? void 0 : _b6.owner;
...
var OutletComponent = class {
  constructor(owner, state) {
    ...
    __publicField(this, "handle", -1);
    __publicField(this, "resolvedName", null);
    __publicField(this, "manager", OUTLET_MANAGER);
    __publicField(this, "capabilities", CAPABILITIES_MASK$1);
    __publicField(this, "compilable");
    this.state = state;
...
var RootComponentDefinition = class {
  constructor(component) {
    // handle is not used by this custom definition
    __publicField(this, "handle", -1);
    __publicField(this, "resolvedName", "-top-level");
    __publicField(this, "state");
    __publicField(this, "manager");
    __publicField(this, "capabilities", capabilityFlagsFrom(ROOT_CAPABILITIES));
    __publicField(this, "compilable", null);
...
setGlobalContext({
  ...
  assert(test, msg, options) {
    if (true) {
      let id = options == null ? void 0 : options.id;
      let override = VM_ASSERTION_OVERRIDES.filter((o) => o.id === id)[0];
      !test && assert((override == null ? void 0 : override.message) ?? msg, test);
    }
  },
...
var _a5, _b5;
if (true) {
  (_b5 = (_a5 = debug) == null ? void 0 : _a5.setTrackingTransactionEnv) == null ? void 0 : _b5.call(_a5, {
    debugMessage(obj, keyName) {
      var _a6, _b6;
      let dirtyString = keyName ? `\`${keyName}\` on \`${(_a6 = getDebugName$1) == null ? void 0 : _a6(obj)}\`` : `\`${(_b6 = getDebugName$1) == null ? void 0 : _b6(obj)}\``;
...
var EmberEnvironmentDelegate = class {
  constructor(owner, isInteractive) {
    __publicField(this, "enableDebugTooling", ENV._DEBUG_RENDER_TREE);
    this.owner = owner;
    this.isInteractive = isInteractive;
  }
  onTransactionCommit() {
...
var resolve = internalHelper(({
  ...
  return createConstRef((_a6 = owner.factoryFor(fullName)) == null ? void 0 : _a6.class, `(-resolve "${fullName}")`);
});
...
var MountDefinition = class {
  constructor(resolvedName) {
    ...
    __publicField(this, "handle", -1);
    __publicField(this, "state");
    __publicField(this, "manager", MOUNT_MANAGER);
    __publicField(this, "compilable", null);
    __publicField(this, "capabilities", capabilityFlagsFrom(CAPABILITIES$1));
...
var RouteTemplate = class {
  constructor(name, template) {
    // handle is not used by this custom definition
    __publicField(this, "handle", -1);
    __publicField(this, "resolvedName");
    __publicField(this, "state");
    __publicField(this, "manager", ROUTE_TEMPLATE_MANAGER);
    __publicField(this, "capabilities", CAPABILITIES_MASK);
    __publicField(this, "compilable");
...
var outletHelper = internalHelper((_args, owner, scope) => {
  ...
  let outletRef = createComputeRef(() => {
    ...
    return (_a6 = state == null ? void 0 : state.outlets) == null ? void 0 : _a6.main;
  });
  let lastState = null;
  let outlet = null;
  return createComputeRef(() => {
    ...
    if (!isStable(state, lastState)) {
      lastState = state;
      if (state !== null) {
        let outletOwner = ((_a6 = outletState == null ? void 0 : outletState.render) == null ? void 0 : _a6.owner) ?? owner;
        let named = dict();
...
var ResolverImpl = class {
  constructor() {
    __publicField(this, "componentDefinitionCache", /* @__PURE__ */ new Map());
  }
  lookupPartial() {
    return null;
  }
...
var ComponentRootState = class {
  constructor(state, definition, options) {
    __publicField(this, "type", "component");
    __privateAdd(this, _result);
    __privateAdd(this, _render);
    __privateSet(this, _render, errorLoopTransaction(() => {
      let iterator = renderComponent(state.context, state.builder(state.env, options.into), state.owner, definition, options == null ? void 0 : options.args);
      let result = __privateSet(this, _result, iterator.sync());
      associateDestroyableChild(this, __privateGet(this, _result));
      __privateSet(this, _render, errorLoopTransaction(() => {
...
var ClassicRootState = class {
  constructor(root, context, owner, template, self, parentElement, dynamicScope, builder) {
    __publicField(this, "type", "classic");
...
var _data, _lastRevision, _inRenderTransaction, _destroyed, _roots, _removedRoots, _RendererState_instances, renderRootsTransaction_fn;
var _RendererState = class _RendererState {
  constructor(data, renderer) {
    __privateAdd(this, _RendererState_instances);
    __privateAdd(this, _data);
    __privateAdd(this, _lastRevision, -1);
    __privateAdd(this, _inRenderTransaction, false);
    __privateAdd(this, _destroyed, false);
    __privateAdd(this, _roots, []);
    __privateAdd(this, _removedRoots, []);
  ...
  get debug() {
    return {
      roots: __privateGet(this, _roots),
      inRenderTransaction: __privateGet(this, _inRenderTransaction),
      isInteractive: this.isInteractive
    };
  }
  get roots() {
    return __privateGet(this, _roots);
  }
  get owner() {
    return __privateGet(this, _data).owner;
  }
  get builder() {
    return __privateGet(this, _data).builder;
  }
  get context() {
    return __privateGet(this, _data).context;
  }
  get env() {
    return this.context.env;
  }
  get isInteractive() {
    return __privateGet(this, _data).context.env.isInteractive;
  }
  renderRoot(root, renderer) {
    let roots = __privateGet(this, _roots);
    roots.push(root);
    associateDestroyableChild(this, root);
    if (roots.length === 1) {
      register(renderer);
    }
    __privateMethod(this, _RendererState_instances, renderRootsTransaction_fn).call(this, renderer);
    return root;
  }
  renderRoots(renderer) {
    let roots = __privateGet(this, _roots);
    let removedRoots = __privateGet(this, _removedRoots);
    ...
    do {
      ...
      inTransaction(this.context.env, () => {
        ...
        __privateSet(this, _lastRevision, valueForTag(CURRENT_TAG));
      });
  ...
  isValid() {
    return __privateGet(this, _destroyed) || __privateGet(this, _roots).length === 0 || validateTag(CURRENT_TAG, __privateGet(this, _lastRevision));
  }
  revalidate(renderer) {
    if (this.isValid()) {
      return;
  ...
  clearAllRoots(renderer) {
    ...
    __privateGet(this, _removedRoots).length = 0;
...
_data = new WeakMap();
_lastRevision = new WeakMap();
_inRenderTransaction = new WeakMap();
_destroyed = new WeakMap();
_roots = new WeakMap();
_removedRoots = new WeakMap();
_RendererState_instances = new WeakSet();
renderRootsTransaction_fn = function(renderer) {
  if (__privateGet(this, _inRenderTransaction)) {
    return;
  }
  __privateSet(this, _inRenderTransaction, true);
  ...
  try {
    ...
    __privateSet(this, _inRenderTransaction, false);
  }
};
var RendererState = _RendererState;
...
var Renderer = class extends BaseRenderer {
  constructor(owner, document2, env, rootTemplate, viewRegistry, builder = clientBuilder, resolver = new ResolverImpl()) {
    ...
    __publicField(this, "_rootTemplate");
    __publicField(this, "_viewRegistry");
...
//# sourceMappingURL=chunk-EIM7BQEH.js.map
